  ...
  return (
    <div className='w-full h-full flex flex-col lg:flex-row justify-evenly'>
      <div className='w-full text-white space-y-14'>
        ...
        <p className='text-4xl lg:text-6xl font-["Coolvetica"] tracking-wider'>
        ...
        <button type="button" className="w-1/2 py-2 px-4 text-[#FFC501] hover:bg-[#FFC501] border-2 border-[#FFC501] hover:text-[#354F60] w-full transition ease-in duration-200 text-center text-base font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 tracking-widest">
          CONTACT ME
        </button>
      </div>
